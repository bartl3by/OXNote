...
class DriveExtendedActionAttributeMap(IdAttributeMap):
    data = 'data'
    action = 'action'
    version = 'version'
...
class DriveExtendedAction(AppsuiteIdModel):
    attribute_map_class = DriveExtendedActionAttributeMap
    attribute_types = {
        'data': DriveDirectoryMetadata,
        'action': str,
    ...
    def __init__(self, data=None, action=None, version=None, new_version=None, path=None, offset=None,
                 total_length=None, content_type=None, created=None, modified=None, error=None, quarantine=None,
                 reset=None, stop=None, acknowledge=None, thumbnail_link=None, preview_link=None, direct_link=None,
