...
class FolderExtendedPermissionAttributeMap(IdAttributeMap):
    entity = 'entity'
    bits = 'bits'
    type = 'type'
...
class FolderExtendedPermission(AppsuiteIdModel):
    attribute_map_class = FolderExtendedPermissionAttributeMap
    attribute_types = {
        'entity': int,
        'bits': int,
        'type': str,
